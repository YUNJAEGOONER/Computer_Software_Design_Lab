...
fun Beer.print(){ println("맥주이름 : ${this.name}, 맥주타입 : ${this.beerType}, 맥주가격 : ${this.cost}")}
fun Beer.change_price(price: Int){this.cost = price}
fun Wine.euro_to_won(operation:(Int,Int)->Int){
    var won = operation(this.cost, 1350)
    println("유로 : ${this.cost}, 원화 : ${won}")
}
